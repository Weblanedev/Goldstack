          ...
          toolsData={[
            {
              ...
              subTitle:
                "Efficiently monitor and manage your cash flows, ensuring your business always has the liquidity needed to meet its obligations.",
            },
            {
              icon: custody,
          ...
          >
            <div className="text-white lg:w-[510px] pt-[20px]">
              ...
              <p className="pt-[14px] pb-[24px] font-[400] text-[18px] leading-[30px] text-[#F6F7F8] lg:w-[508px]">
                Goldstack empowers companies from 115+ countries to accelerate
                their operations in frontier markets through better foreign
                exchange, treasury services, payments, and last-mile settlement.
              </p>

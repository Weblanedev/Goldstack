	...
	return (
		<>
			<Hero
				...
				subTitle='Goldstack all-in-one asset independent infrastructure, empowers financial service providers with the tools that they need to build and scale.'
			...
			>
				...
				>
					...
					>
						...
						<div className='h-fit'>
							<img src={buildImg} alt='build Goldstack' className='h-full' />
						</div>
					</div>
				</div>
			</section>

	...
	`}
			>
				<div className="relative text-white">
					<video autoPlay muted playsInline loop id="myVideo" className="absolute top-0 left-0 w-full h-[100vh] object-cover z-0">
						<source src="https://res.cloudinary.com/dqew5naa7/video/upload/v1722429636/4687197-uhd_3840_2160_24fps_ohq6sg.mp4" type="video/mp4" />
						...
						<div className="flex flex-col justify-between gap-12 lg:gap-16 items-center">
							<div className="py-[14px] md:pb-[27px] md:pt-[0px] text-center">
								...
								<p className="pt-[16px] font-[400] pb-[25px] text-[18px] lg:text-[20px] leading-[35px] w-[80%] mx-auto">
									Goldstack is a single platform for all your payments, FX and treasury. We are powering the FX behind Africa's Trillion dollar growth
								</p>
					...
					>
						...
						>
							...
							<h2 className='mt-[8px] mb-[24px] font-[600] text-[24px] leading-[36px] text-[#101828]'>
								Seamlessly manage your enterprise’s cross-border cash flows, transfers, and liquidity needs with our advanced feature.

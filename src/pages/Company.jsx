...
const Company = () => {
	...
	`}
		...
		text-center
          ...
          >
            ...
            >
              ...
              >
                Here at, GoldStack, we take pride in our talented and diverse
                team that drives our mission forward and delivers exceptional
              ...
              <p
                ...
                className="
						...
						text-[16px] lg:text-[20px] lg:leading-[35px]"
              >
                We believe that the best solutions arise from diverse
                perspectives and collective intelligence. By fostering a
                collaborative environment, we empower our team members to
                thrive, ensuring our customers receive cutting-edge solutions.
              </p>
              <div
                ...
                //  lg
              >
                <Link to="/products/payment-links" className="mx-auto">
                  <Button
                    type="primary"
      ...
      <DescriptionComp
        minTitle="Why Goldstack?"
        title="Helping our customers build for scale and impact"
        subTitle="Our mission is to fix the issues with banking limitations and help business access new markets"
        link={false}
      />
      <section
        className="container

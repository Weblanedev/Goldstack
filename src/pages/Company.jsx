		...
		text-center
					...
					lg:text-[48px] font-[600] lg:leading-[53px]
					 '
							...
							>
								Here at, GoldStack, we take pride in our talented and diverse team that drives our mission forward and delivers exceptional solutions to our valued customers.
							</p>
							<p
								// pt-[16px]
								// lg:pt-[38px]
						...
						text-[16px] lg:text-[20px] lg:leading-[35px]'
							>
								We believe that the best solutions arise from diverse perspectives and collective intelligence. By fostering a collaborative environment, we empower our team members to thrive, ensuring our customers receive cutting-edge solutions.
							</p>
							<div

...
export const Button = ({ btnText, bgColor, icon, fullWidth }) => (
	<button
		...
		className={className(
			fullWidth === true
				? 'w-full flex bg-black text-white items-center justify-center font-[500] text-[18px] leading-[24px] py-[12px] px-[16px] rounded-md gap-[12px]'
				: bgColor === true
				? 'flex bg-black text-white items-center font-[500] text-[18px] leading-[24px] py-[12px] px-[16px] gap-[12px] rounded-md'
				: 'flex bg-white text-black items-center font-[500] text-[18px] leading-[24px] py-[12px] px-[16px] gap-[12px] rounded-md'
		)}
	>
		{btnText}
		{icon === true && (
